...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 10.02.05, February 17, 2024 17:20:45):
...
app_logger.info(f'Created February 17, 2024 17:20:45 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 10.02.05\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 10.02.05\n'
    msg += f'.. startup message: {start_up_message}\n'
